...
CREATE PROCEDURE SPAddress_Book (@FIRSTNAME VARCHAR(50),@LASTNAME VARCHAR(50),@ADDRESSs VARCHAR(100),
@CITY VARCHAR(25),@STATE VARCHAR(50),@ZIP VARCHAR(6),@PHONENO VARCHAR(12),@EMAIL VARCHAR(50))
AS
BEGIN
SET NOCOUNT ON;
INSERT INTO Address_Book([FIRSTNAME],[LASTNAME],[ADDRESSs],[CITY],[STATE],[ZIP],[PHONENO],[EMAIL])
VALUES(@FIRSTNAME,@LASTNAME,@ADDRESSs,@CITY,@STATE,@ZIP,@PHONENO,@EMAIL)
END
GO
EXEC [dbo].[SPAddress_Book] @FIRSTNAME='RAMYA',@LASTNAME='OLETI',@ADDRESSs='25/89',
@CITY='ELURU',@STATE='ANDHRA PRADESH',@ZIP=524543,@PHONENO=8796567854,@EMAIL='ramya@gmail.com';
GO
SELECT * FROM Address_Book;